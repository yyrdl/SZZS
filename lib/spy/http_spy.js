...
function addSpy(http){
    ...
    http.request=function(){
        ...
        var record={
            ...
            "is_error":false,
            "error":"",
            "dest":"http://"+options.host+":"+options.port+"/"+options.path
        };
        var request_Start=0;
        function cb(res){
    ...
    http.createServer=function(){
        ...
        function cb(req,res){
            var h_start=Date.now();
            record.dest="http://"+record.host_ip+":"+record.host_port+req.url;
